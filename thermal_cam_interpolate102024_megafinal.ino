...
#define TFT_DC 2
#define TFT_CS 15
//arduino cs10 dc9  ; esp dc 2 cs 15
...
void setup() {
  ...
  uint32_t colors[] = {0XFFCC55, RED, 0XFFCC55}; // create an array of colors - second color is transition
  ws2812fx.setSegment(0, 0, 7, 55, colors, 3000);
  ws2812fx.start();
